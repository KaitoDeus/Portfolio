...
export default function Hero() {
  ...
  // Get role from translation
  const currentRole = t('hero.role');

  // Random quote index - selected once on mount
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 px-[5%]">
      <motion.div 
      ...
      >
        ...
        <h3 className="text-2xl md:text-3xl mt-4 mb-4">
          {t('hero.greeting')} <span className="text-orange">{displayText}</span>
