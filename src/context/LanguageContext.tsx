...
const translations: Record<Language, Record<string, string>> = {
  ...
  vi: {
    ...
    'projects.category.personal': 'Dự án Cá nhân',
    'projects.category.school': 'Dự án Học tập',
    ...
    'projects.noDescription': 'Không có mô tả chi tiết cho dự án này.',
    'projects.search.placeholder': 'Tìm kiếm dự án...',
    'projects.sort.label': 'Sắp xếp theo thời gian:',
    'projects.sort.default': 'Mặc định',
    'projects.sort.newest': 'Mới nhất',
